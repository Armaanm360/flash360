...
class AdminPropertyService extends abstract_service_1.default {
    ...
    getSingleProperty(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const data = yield model.getSingleProperty({ id: Number(id) });
            if (!data.length) {
                return {
                    success: false,
    ...
    getMyProperties(req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data, total } = yield model.getClientProperties(Object.assign({}, queryParams));
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (verification === true) {
                    ...
                    if (!rejection_reason) {
                        throw new Error('Rejection reason must be provided if verification is false.');
                    }
                }
                else {
                    throw new Error('Invalid verification status. It must be either true or false.');
                }
                // Call the model to update the property verification details
                const model = this.Model.propertyModel();
                yield model.verifyProperty(Number(propertyId), req.body);
    ...
    getAllAmenity(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const model = this.Model.propertyModel();
            const { data, total } = yield model.getAllAmenity(req.admin.id, Object.assign({}, req.query));
            return {
                success: true,
                code: this.StatusCode.HTTP_OK,
                message: this.ResMsg.HTTP_OK,
    ...
    getAllPropertyListing(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const model = this.Model.propertyModel();
            const { data, total } = yield model.getAllPropertyListing(Object.assign({}, req.query));
            return {
                success: true,
                code: this.StatusCode.HTTP_OK,
                message: this.ResMsg.HTTP_OK,
