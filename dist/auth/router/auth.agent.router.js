...
const auth_agent_controller_1 = require("../controller/auth.agent.controller");
class AgentAuthRouter extends abstract_router_1.default {
    constructor() {
        super();
        this.controller = new auth_agent_controller_1.AgentAuthController();
    ...
    callRouter() {
        ...
        this.router
            ...
            .patch(this.authChecker.agentAuthChecker, this.controller.updateProfile);
        // // forget password
        // this.router
