...
class AgentModel extends schema_1.default {
    ...
    createTeacher(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.db('admin_user')
                .withSchema(this.USER_SCHEMA)
                .insert(payload, 'id');
            return data;
        });
    ...
    createParticipant(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.db('participants')
                .withSchema(this.USER_SCHEMA)
                .insert(payload, 'id');
            return data;
        });
    }
    insertAnswer(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.db('answers')
                .withSchema(this.USER_SCHEMA)
                .insert(payload);
            return data;
        });
    ...
    getAllTopics() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const total = yield this.db('topics')
                .withSchema(this.USER_SCHEMA)
                .count('id AS total');
            return {
                data: yield data,
    ...
    getAllTopicsWiseQuestion(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db('questions')
                .withSchema(this.USER_SCHEMA)
    ...
    getSingleProfileAgent(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db('admin_user')
                .withSchema(this.USER_SCHEMA)
                .where({ id: id });
        });
    }
