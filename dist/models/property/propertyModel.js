...
class PropertyModel extends schema_1.default {
    ...
    createTopic(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.db('topics').withSchema(this.USER_SCHEMA).insert(payload); // verify new property
        });
    }
    ...
    createProperty(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            const data = yield this.db('questions')
                .withSchema(this.USER_SCHEMA)
