...
class AgentPropertyService extends abstract_service_1.default {
    ...
    createTopic(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                const model = this.Model.propertyModel(trx);
                const data = yield model.createTopic({
                    name: req.body.name,
    ...
    createQuiz(req) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.db.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                yield model.createQuestion(formattedQuestions);
                return {
                    success: true,
                    code: this.StatusCode.HTTP_SUCCESSFUL,
                    message: this.ResMsg.HTTP_SUCCESSFUL,
    ...
    getAllAmenity(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const model = this.Model.propertyModel();
            const { data, total } = yield model.getAllAmenity(req.agent.id, Object.assign({}, req.query));
            return {
                success: true,
                code: this.StatusCode.HTTP_OK,
                message: this.ResMsg.HTTP_OK,
    ...
    getAllTopicsWiseQuest(req) {
        return __awaiter(this, void 0, void 0, function* () {
            const model = this.Model.agentModel(); // Get the property model
            const id = Number(req.params.id);
            const data = yield model.getAllTopicsWiseQuestion(id);
            return {
                success: true,
                code: this.StatusCode.HTTP_SUCCESSFUL,
