...
class ClientPropertyController extends abstract_controller_1.default {
    constructor() {
        ...
        // { arrayBodySchema: this.ActivityValidator.createActivity },
        {}, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _j = yield this.service.getAllTopicsWiseQuest(req), { code } = _j, data = __rest(_j, ["code"]);
            res.status(code).json(data);
        }));
        // get all eminities
        this.createTopic = this.asyncWrapper.wrap(
        // { arrayBodySchema: this.ActivityValidator.createActivity },
        {}, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _k = yield this.service.createTopic(req), { code } = _k, data = __rest(_k, ["code"]);
            res.status(code).json(data);
        }));
        this.createQuiz = this.asyncWrapper.wrap(
        // { arrayBodySchema: this.ActivityValidator.createActivity },
        {}, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _l = yield this.service.createQuiz(req), { code } = _l, data = __rest(_l, ["code"]);
            res.status(code).json(data);
        }));
        // get all features
        ...
        // { arrayBodySchema: this.ActivityValidator.createActivity },
        {}, (req, res) => __awaiter(this, void 0, void 0, function* () {
            const _m = yield this.service.getAllFeatures(req), { code } = _m, data = __rest(_m, ["code"]);
            res.status(code).json(data);
        }));
    }
}
