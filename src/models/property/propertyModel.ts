...
class PropertyModel extends Schema {
  ...
  public async createTopic(payload: any) {
    return await this.db('topics').withSchema(this.USER_SCHEMA).insert(payload); // verify new property
  }
  public async createQuestion(payload: any[]) {
    return await this.db('questions')
      .withSchema(this.USER_SCHEMA)
      .insert(payload); // verify new property
  }
  ...
  public async createProperty(payload: any[]) {
    const data = await this.db('questions')
      .withSchema(this.USER_SCHEMA)
  ...
  public async addResult(payload: any) {
